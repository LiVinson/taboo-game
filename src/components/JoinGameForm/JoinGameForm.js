...
import { Form, FormSection, TextInput, TextLabel, ErrorText } from 'components/shared/FormElements'
			...
			{(formik) => (
				<Form id="joinGameForm">
					...
					<FormSection>
						...
						<Field id="gamecode" name="gamecode" type="text" as={TextInput} placeholder="" tabIndex="1" />
